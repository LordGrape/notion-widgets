...
const MOVED = [
  ...
  ['createLearnFlow', join('src', 'application', 'learn', 'flow-state.ts')],
  ['createStreamingLearnFlow', join('src', 'application', 'learn', 'flow-state.ts')],
  ['currentSegment', join('src', 'application', 'learn', 'flow-state.ts')],
  ['isLastSegment', join('src', 'application', 'learn', 'flow-state.ts')],
  ['markLoading', join('src', 'application', 'learn', 'flow-state.ts')],
  ['markError', join('src', 'application', 'learn', 'flow-state.ts')],
  ['applyTurnResult', join('src', 'application', 'learn', 'flow-state.ts')],
  ['markReadComplete', join('src', 'application', 'learn', 'flow-state.ts')],
  ['markPrequestionComplete', join('src', 'application', 'learn', 'flow-state.ts')],
  ['markScaffold', join('src', 'application', 'learn', 'flow-state.ts')],
  ['markAssisted', join('src', 'application', 'learn', 'flow-state.ts')],
  ['continueToNextSegment', join('src', 'application', 'learn', 'flow-state.ts')],
  ['jumpToSegment', join('src', 'application', 'learn', 'flow-state.ts')],
  ['isReadPhase', join('src', 'application', 'learn', 'flow-state.ts')],
  ['isPrequestionPhase', join('src', 'application', 'learn', 'flow-state.ts')],
  ['isAnswerPhase', join('src', 'application', 'learn', 'flow-state.ts')],
  ['isScaffoldPhase', join('src', 'application', 'learn', 'flow-state.ts')],
  ['isFeedbackPhase', join('src', 'application', 'learn', 'flow-state.ts')],
  ['wasAssisted', join('src', 'application', 'learn', 'flow-state.ts')],
  ['linkedCardIdsForSegment', join('src', 'application', 'learn', 'flow-state.ts')],
  ['enterConsolidation', join('src', 'application', 'learn', 'flow-consolidation.ts')],
  ['submitConsolidationRating', join('src', 'application', 'learn', 'flow-consolidation.ts')],
  ['skipConsolidation', join('src', 'application', 'learn', 'flow-consolidation.ts')],
  ['isConsolidationComplete', join('src', 'application', 'learn', 'flow-consolidation.ts')],
  ['getFsrsHandoffPlan', join('src', 'application', 'learn', 'flow-consolidation.ts')],
  ['appendStreamedSegment', join('src', 'application', 'learn', 'flow-streaming.ts')],
  ['markStreamingComplete', join('src', 'application', 'learn', 'flow-streaming.ts')],
  ['attachStreamedConsolidationQuestions', join('src', 'application', 'learn', 'flow-streaming.ts')],
  ['getLoadedSegmentCount', join('src', 'application', 'learn', 'flow-streaming.ts')],
  ['getTotalExpectedSegments', join('src', 'application', 'learn', 'flow-streaming.ts')],
  ['isStreamingComplete', join('src', 'application', 'learn', 'flow-streaming.ts')],
  ['canAdvanceToNextSegment', join('src', 'application', 'learn', 'flow-streaming.ts')],
  ['markSegmentEntered', join('src', 'application', 'learn', 'flow-telemetry.ts')],
  ['markTurnSubmitted', join('src', 'application', 'learn', 'flow-telemetry.ts')],
  ['markTurnContinuation', join('src', 'application', 'learn', 'flow-telemetry.ts')],
  ['markSessionCompleted', join('src', 'application', 'learn', 'flow-telemetry.ts')],
  ['markAbandoned', join('src', 'application', 'learn', 'flow-telemetry.ts')],
  ['getLearnTelemetrySummary', join('src', 'application', 'learn', 'flow-telemetry.ts')],
  ['computeLearnMasteryProjection', join('src', 'application', 'learn', 'flow-mastery.ts')],
];
